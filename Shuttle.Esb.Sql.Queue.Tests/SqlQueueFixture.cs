...
namespace Shuttle.Esb.Sql.Queue.Tests
{
    ...
    public class SqlQueueFixture : BasicQueueFixture
    {
        ...
        {
            TestUnacknowledgedMessage(SqlConfiguration.GetServiceCollection(), "sql://shuttle/{0}");
        }
        ...
        {
            TestSimpleEnqueueAndGetMessage(SqlConfiguration.GetServiceCollection(), "sql://shuttle/{0}");
        }
        ...
        {
            TestReleaseMessage(SqlConfiguration.GetServiceCollection(), "sql://shuttle/{0}");
        }
